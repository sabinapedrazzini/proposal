...
The first important gap in the literature about cooperation in commons is the lack of quantitative studies that took place in real-life commons. In fact, the most common approach to the study of real commons is qualitative/observational [e.g. @Ostrom1990]. Papers that used quantitative methods usually simulated a commons in a laboratory [e.g. @Mosler1993]. Although it offers a standard paradigm to the study of cooperation [@Balliet2011], this approach does not allow to exactly reproduce all the dynamics of a commons [@Cole2010; @Henry2011]: some elements such as cultural factors and specific ecological conditions affecting the decision-making process cannot be reproduced in lab experiments [@Janseen2015].

Therefore, to the author's knowledge, there are few or no studies that investigates the causal relation of different factors on cooperation in real-life commons.
