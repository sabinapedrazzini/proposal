...
As a result, there is a lack of studies that used a quantitative method to investigate the causal effect of individual and group factors on people's willingness to cooperate in a real-life commons. Therefore, combining these two categories would allow to complete the literature about cooperation in commons. More specifically, by adopting a quantitative method in real-life settings, it could be possible to have a better understanding of the conditions that improve cooperation, without the disadvantages of a laboratory study. Moreover, in real-life study there is a lack of focus on individual characteristics. For this reason, applying an individual perspective would allow to have a better understanding of why some people cooperate more than others, and why some in some commons there is more cooperation than in others.

More recent studies already started to fill these gaps. For instance, @Franzen2019 found that farmer's trust in others predicts the probability to have a self-administered outlet in Swiss farms. Moreover, @VanVugt2009 resumed several studies that investigated the causal impact of incentives and social identity on the cooperation for a management of a shared resource. Finally, @Noonan2016 studied self-organized dog parks in the United States, and used survey to collect data about participants feelings and behaviours. They found that people's sense of community predicts the amount of time spent doing voluntary activities for the maintaining of the park.

However, the self-administered outlets in @Franzen2019 do not fit exactly in the definition of commons used for the current paper, while @VanVugt2009 focalized on the management of shared resources in extreme situations (e.g. a water shortage). Finally, @Noonan2016: ok, but methodology not top and more focus on institutions than on people (check).

At the same time, there are studies that start to include a more individual-centered approach in the study of commons:
...
Moreover: focusing on the commoners also allows to investigate how being part of a commons change their perspective on society. This could supplementary insight on the literature of why commons can contribute to a better society (insert category 3) => all these papers usually focus, again, on the commons as a whole. However, an individual perspective is very useful.

eventual third category: 3.  Theoretical papers about commons, where the authors analyze the commons from a theoretical perspective. These papers usually focus on how to define commons [e.g. @Hess2008], how commons have evolved [e.g. @Federici2011], or how they could contribute in changing our society [e.g. @Bollier2014].
...
(@Tajfel1974) => to justify some research questions
